  ...
  return (
    <div id='newUserForm'>
      ...
      <form onSubmit={handleSubmit}>
        <label>First Name: 
          <input type='text' name='firstName' onChange={handleChange} value={firstName}></input>
        </label>
        <label>Last Name: 
          <input type='text' name='lastName' onChange={handleChange} value={lastName}></input>
        </label>
        <label>Email Address: 
          <input type='text' name='email' onChange={handleChange} value={email}></input>
        </label>
        <label>Phone Number: 
          <input type='text' name='telephone' onChange={handleChange} value={telephone}></input>
        </label>
        <label>Date of Birth: 
          <input type='date' name='birthDate' onChange={handleChange} value={birthDate}></input>
        </label>
        <label>Password: 
