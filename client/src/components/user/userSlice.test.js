...
describe('User reducer actions', () => {
  ...
  const testUser = { first_name:'Test', last_name:"User", email_address: 'test@email.com' };
  const loggedInInitial = { user: testUser, loggedInStatus: { loggedIn: true, message: null }};
...
describe('User selectors', () => {
  ...
  const mockState = { user: { user: 'Test User' }, loggedInStatus: { loggedIn: true, message: 'Msg' }};
